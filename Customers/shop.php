...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
         ...
         <center><h3> <span class="glyphicon glyphicon-shopping-cart"></span> This is our services available, Shop now!</h3></center>
        </div>
...
<textarea style='text-align:center;background-color: white;' class='form-control' rows='1' disabled>".$query2['item_name']."</textarea>
           ...
           <a class='fancybox-buttons' href='../Admin/item_images/".$query2['item_image']."' data-fancybox-group='button' title='Page ".$id."- ".$query2['item_name']."'>
					...
					<center><h4> Price: RM ".$query2['item_price']." </h4></center>
...
?>
			...
			<div class="alert alert-default" style="background-color:#033c73;">
                       ...
                       © 2023 BIZMART E - PRINTING &nbsp;| All Rights Reserved |  Design by : BIZMART Team</p>
